...
with demo:
    gr.Markdown(
        "‼️Disclaimer: data pdf is from  https://www.mdthinducollege.org/ebooks/anatomy%20and%20Physiology/Functional_Anatomy.pdf"
    )
    
    chatbot = gr.ChatInterface(
        respond,
        examples=[
           ["What are the key muscles involved in a lower body workout?"],
            ["What are some common injuries related to running?"],
            ["How can I prevent ankle sprains during workouts?"],
            ["What exercises can improve core stability?"],
            ["Why is gait analysis important for athletes?"],
            ["How does the structure of the foot contribute to its function during physical activities?"],
            ["What role do ligaments play in joint stability?"],
        ],
        title='TotalBodyTrainingCoach🏋🏻‍♀️ 💪🏽'
    )
